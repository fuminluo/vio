...
import priv.rabbit.vio.entity.TreeNode;
...
public class TreeBuiderUtil {
     ...
     * @return
     */
    public static List<TreeNode> buildByRecursive(List<TreeNode> treeNodes,String parentId) {
        List<TreeNode> trees = new ArrayList<TreeNode>();
        for (TreeNode treeNode : treeNodes) {
            if (parentId.equals(treeNode.getParentId())) {
    ...
    public static void main(String[] args) {
       ...
       /* list.add(treeNode8);
        ...
        List<TreeNode> trees = bulid(list,"0");
